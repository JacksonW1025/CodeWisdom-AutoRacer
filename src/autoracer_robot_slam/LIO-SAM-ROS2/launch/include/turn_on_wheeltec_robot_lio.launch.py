...
def generate_launch_description():
    ...
    #autoware robot:autoware_akm_pro/autoware_akm_ultra_dual_antenna/autoware_akm_ultra_single_antenna/
    #autoware robot:autoware_s200_dual_antenna/autoware_s200_single_antenna
    ...
    flagship_type = IncludeLaunchDescription(
            ...
            launch_arguments={'autoware_s200_single_antenna': 'true'}.items(),
    )
